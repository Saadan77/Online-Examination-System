                    ...
                    <table class="auto-style1">
                        <tr>
                            ...
                            <td>
                                ...
                                <br />
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OnlineExamConnectionString %>" SelectCommand="SELECT [id], [name], [image] FROM [userInfo] WHERE ([semester] = @semester)">
                                    <SelectParameters>
